...
describe('Blockchain', () => {
  ...
  describe('replaceChain()', () => {
    ...
    describe('when the new chain is longer', () => {
      beforeEach(() => {
        newChain.addBlock({ data: 'Ananas' });
        newChain.addBlock({ data: 'Prune' });
        newChain.addBlock({ data: { name: 'Patate', price: 2 } });
        newChain.addBlock({ data: 'Pamplemousse' });
      });
